...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to get all customers & accounts details"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<List<CustomerDto>> fetchAllAccounts() {
        return ResponseEntity.status(HttpStatus.OK).body(iAccountsService.fetchAllCustomers());
    }

    @Operation(
            summary = "Get information REST API",
            description = "Get information REST API"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
